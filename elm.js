...
var $author$project$Main$Story = F5(
	function (author, title, subtitle, domain, url) {
		return {author: author, domain: domain, subtitle: subtitle, title: title, url: url};
	});
		...
		$elm$http$Http$request(
			{
				...
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotJson, $author$project$Main$threeDecoder),
				headers: _List_Nil,
				method: 'GET',
...
var $author$project$Main$edges = {bottom: 5, left: 5, right: 5, top: 5};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(story.title)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(story.subtitle)
						]))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
...
var $author$project$Main$cardLink = function (story) {
	return A2(
		...
		_List_Nil,
		{
			label: $author$project$Main$card(story),
			url: story.url
		});
};
...
var $author$project$Main$map_v = function (storyList) {
	return A2(
		$mdgriffith$elm_ui$Element$wrappedRow,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$vr, storyList.storyList));
};
